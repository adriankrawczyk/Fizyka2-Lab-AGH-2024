...
SMALL_ROW = [False for _ in range(8)] + [True for _ in range(3)]
FULL_ROW = [(i % 2 == 1) for i in range(8)] + [True for _ in range(3)]

BASIC_STRUCTURE = [SMALL_ROW for _ in range(4)] + [FULL_ROW for _ in range(11)] + [SMALL_ROW for _ in range(4)]
